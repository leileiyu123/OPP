...
(function(ab, z) {
	...
	function o(ar, m) {
		return [
			[(ar[0][0] * m[0][0] + ar[0][1] * m[1][0]), (ar[0][0] * m[0][1] + ar[0][1] * m[1][1]), (ar[0][0] * m[0][2] + ar[0][1] * m[1][2] + ar[0][2])],
			[(ar[1][0] * m[0][0] + ar[1][1] * m[1][0]), (ar[1][0] * m[0][1] + ar[1][1] * m[1][1]), (ar[1][0] * m[0][2] + ar[1][1] * m[1][2] + ar[1][2])]
		]
	}
