...
<html>
	...
	<body ng-app="ylApp">
		<div class="orderBox" ng-controller="myController">
			<div class="order1">
				<div class="order1_1">
					<a href="">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="88%" height="35">
								...
								<input ng-model="name" type="text" name="name" id="name" class="inputcss" style="width:220px; height: 25px;" /></td>
						</tr>
						<tr>
							<td height="35" align="right"><span class="order6_1">*</span>收货地址：</td>
							<td height="35">
								<input ng-model="sell" name="sell" id="sel1" type="text" class="city_input" readonly="readonly" style="width:220px;height: 25px;">
							</td>
						</tr>
						<tr>
							<td height="35" align="right"><span class="order6_1">*</span>街道：</td>
							<td height="35"><input ng-model="street" type="text" name="street" id="street" class="inputcss" style="width:220px;height: 25px;" /></td>
						</tr>
						<tr>
							<td height="35" align="right"><span class="order6_1">*</span>收货人手机：</td>
							<td height="35"><input ng-model="phone" type="text" name="phone" id="phone" class="inputcss" style="width:220px;height: 25px;" /></td>
						</tr>
						<tr>
							<td height="35" align="right">固定电话：</td>
							<td height="35"><input ng-model="phone2" type="text" name="phone2" id="phone2" class="inputcss" style="width:220px;height: 25px;" /></td>
						</tr>
						<tr>
							<td height="35" align="right"></td>
							<td height="35"><input ng-click="submit()" class="go-wenbenkuang" type="submit" name="Submit42" value="提交地址" onclick='subAddress();'> </td>
						</tr>
					</table>
				</div>
			</form>
...
//				if($scope.name != "" && $scope.sell != "" && $scope.street != "" && $scope.phone != ""){
//					var url = "http://localhost:9080/insert?name="+$scope.name+"&sell="+$scope.sell+"&street="+$scope.street+"&phone="+$scope.phone;
