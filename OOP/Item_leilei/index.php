						...
						<div class="so1bew">
							<div class="so1bew_1">
								...
								<ul class="downul">
									...
									<p class="plook">
										<a href="car.php" class="look"><img src="img/img01.gif" alt="加入购物车" width="72" height="20"></a>
									</p>
								</ul>
							</div>
		...
		<div class="banner" ng-controller="myc">
			...
			<div class="focusBox" style="margin:0 auto">
				<ul class="pic">
					...
					<li>
						<a href="#" target="_blank"><img alt="" src="img/banner/banner07.jpg"></a>
					</li>
					<li>
						<a href="#" target="_blank"><img alt="" src="img/banner/banner08.jpg"></a>
					</li>
					<li>
						<a href="#" target="_blank"><img alt="" src="img/banner/banner08.jpg"></a>
					</li>
				...
				<div class="fBox" ng-repeat="x in cheap">
					<div class="fBoxPic">
						<p style="height: 20px;overflow: hidden;text-overflow: ellipsis;text-overflow: ellipsis;">
							<a href="xiangqing.html?cheapId='{{x.cheapId}}'&productName='{{x.productName}}">{{x.productName}}</a>
						</p>
						<div>
							<a href="xiangqing.html?cheapId='{{x.cheapId}}'&productName='{{x.productName}}">
						...
						<div class="fBBot" style="margin: 0px -10px">
							...
							<dd class="fBBotBuy" style="float: right; margin: 5px 10px;" href="#">购买</dd>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="oneFloorDetail">
						...
						<div class="detailBottom">
							<div class="detB" ng-repeat=" x in floorDetail[p_index]">
								<a href="xiangqing.html?floorId={{x.floorId}} &productName='{{x.productName}}">
